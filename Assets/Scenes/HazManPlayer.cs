...
public partial class HazManPlayer : CharacterBody2D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (all_right && ((sprite_node_pos_tween == null) || !sprite_node_pos_tween.IsRunning()) && (state == haz_state.IDLE || state == haz_state.MOBILE || state == haz_state.CHARGING || state == haz_state.I_FRAMES))
        {
